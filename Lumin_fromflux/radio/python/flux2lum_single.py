...
print('pm', flux_err * 1e-26 * ( 4*np.pi * (dist * 1e6 * 3.08567758e16)**2), end=' ')
print('W/Hz')
print(flux * 1e-26 * 1e7 * ( 4*np.pi * (dist * 1e6 * 3.08567758e16)**2), end=' ')
print('pm', flux_err * 1e-26 * 1e7 * ( 4*np.pi * (dist * 1e6 * 3.08567758e16)**2), end=' ')
print('erg/s/Hz')
print('with K-correction: (alpha:'+str(alpha)+')')
print(kcorr(flux,z,alpha) * 1e-26 * ( 4*np.pi * (dist * 1e6 * 3.08567758e16)**2), end=' ')
print('pm', kcorr(flux_err,z,alpha) * 1e-26 * ( 4*np.pi * (dist * 1e6 * 3.08567758e16)**2), end=' ')
print('W/Hz')
print(kcorr(flux,z,alpha) * 1e-26 * 1e7 * ( 4*np.pi * (dist * 1e6 * 3.08567758e16)**2), end=' ')
print('pm', kcorr(flux_err,z,alpha) * 1e-26 * 1e7 * ( 4*np.pi * (dist * 1e6 * 3.08567758e16)**2), end=' ')
print('erg/s/Hz')
