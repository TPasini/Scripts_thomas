...
class AllImages():
    ...
    def regrid_common(self, size=None, radec=None, pixscale=None, pix_per_bmin=None, square=False):
        """
        ...
        if pixscale and pix_per_bmin:
            ...
            cdelt = np.mean(np.abs(self.images[0].get_wcs().wcs.cdelt))  # could also use 1/5 of minor axes (deg)
