...
def linsq_spidx(nu, S, Serr = None):
    ...
    if Serr is None:
        ...
        # print(alpha, delta_alpha, delta_alpha2)
        # print(alpha, delta_alpha2)
...
# def twopoint_spidx_fit(freq, flux, flux_cov):
#
#     lfreq = np.log10(freq)
#     lflux = np.log10(flux)
#     lflux_cov = np.log10(flux_cov)
#
#     optimize.curve_fit(f, lfreq, lflux, sigma=)
